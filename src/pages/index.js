// Arquivo: src/pages/index.js (Versão COMPLETA e CORRIGIDA)
...
export default function Home() {
  ...
  // URL do Remix corrigida para um link padrão do YouTube
  const handleRemix = (videoId) => { if (!videoId) return; const url = `https://www.youtube.com/watch?v=${videoId}`; window.open(url, '_blank'); }; 
  ...
  // Próximo/Anterior usam as listas separadas
  ...
  // loadVideo para busca
  const loadVideo = (playerNum, newVideoId) => { console.warn("loadVideo da busca não atualiza playlists nesta versão."); if (playerNum === 1) setVideo1Id(newVideoId); else setVideo2Id(newVideoId); };
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-900 text-white font-sans">
      ...
      {/* ----- Barra Superior (Controle Velocidade CORRIGIDO) ----- */}
      <div className="w-full p-3 bg-gray-800 bg-opacity-80 backdrop-blur-sm flex items-center justify-between sticky top-0 z-20 shadow-md">
          ...
          <div className="flex items-center justify-center flex-grow mx-4 sm:mx-8">
              ...
              />
              {/* Span da velocidade corrigido, sem span externo extra */}
      ...
      {isLoadingPlaylists ? ( 
          ...
          <main className="flex-grow flex flex-col items-center justify-center p-4 pt-4 md:pt-6">
            ...
            <div className="w-full max-w-md p-6 md:p-8 mt-8 bg-gray-800 bg-opacity-70 rounded-xl shadow-2xl border border-gray-700">
